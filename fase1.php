         ...
         <div class="container-fluid ">
             <div class="row d-flex justify-content-center">
                 ...
                 <div class="col-md-10">
                     ...
                     <div class="fundo_trans h-100  p-5 pt-4">
                         <!--<h2 class="text-center text-light">ATUALIZAÇÃO DE <br> DADOS UNIFACEMA</h2>-->
                        ...
                        <div class="col">
                            <input type="text" id="cres" name="cres" class="form-control"  onkeypress='return SomenteNumero(event)' pattern="[0-9]{8}" maxlength="8" oninvalid="setCustomValidity('Informe um número válido')" title="Informe um número válido" placeholder="Numero de contato">
                             ...
                             <div class="caixa p-4 mt-4">
                                 ...
                                 <p class="text-center style2"><?php echo utf8_encode($dadosEnquete->subtitulo); ?>
                                     <p />
                                     ...
                                     <?php
                                        ...
                                        foreach ($qstEnquete as $quetao) {
                                            if ($quetao->NUMEROQUESTAO < 8 or 1 == 1) {
                                                echo '<div class="form-group">';
                                            } else {
                                                echo '<div class="form-group d-none qst' . $quetao->NUMEROQUESTAO . '">';
                                            }
